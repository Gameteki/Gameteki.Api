node {
    ...
    stage('Build, Test and Sonar Qube') {
        ...
        withSonarQubeEnv('Local Sonar') {
            ...
            sh(script: "coverlet CrimsonDev.Gameteki.Api.Tests/bin/Release/netcoreapp2.2/CrimsonDev.Gameteki.Api.Tests.dll --target 'dotnet' --targetargs 'test CrimsonDev.Gameteki.Api.Tests/CrimsonDev.Gameteki.Api.Tests.csproj --no-build -c Release' --format opencover", returnStdout: true)
